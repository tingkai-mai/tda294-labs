...
public class NumericTextBox {
	...
	/*@
	  ...
	  @*/
	public void clear() {
		// Use while loop for invariant practice

		/*@
		  @ loop_invariant
		  @ cursor_position >= 0 && cursor_position <= content.length &&
		  @ (\forall int i; 0 < i && i < cursor_position; content[i] != EMPTY) &&
		  @ (\forall int i; i > cursor_position && i < content.length; content[i] == EMPTY);
		  @ assignable cursor_position, content[*];
		  @ decreasing cursorPosition;
		  @*/
